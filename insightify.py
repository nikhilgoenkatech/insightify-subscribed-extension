...
class RemoteInsightifyExtension(RemoteBasePlugin):
            ...
            if end_time != -1:
              ...
              if int(resolution_time) >= int(self.converted_to_incident_duration): 
                ...
                if (data[i]["rootCauseEntity"]):
                   ...
                   csv_data = csv_data + entityID + "," + endpoint + ",INFO,\"" + key + "\"," + data[i]["displayId"] + "," + self.url[:-7] + "#problems/problemdetails;gf=all;pid=" + data[i]["problemId"] + "," + data[i]["title"] + "," + data[i]["impactLevel"] + "," + data[i]["severityLevel"] + ",rca," + str(resolution_time/360000) + "\n"
                   ...
                   csv_data = csv_data + entityID + "," + endpoint + ",INFO,\"" +  key + "\"," + data[i]["displayId"] + "," + self.url[:-7] + "#problems/problemdetails;gf=all;pid=" + data[i]["problemId"] + "," + data[i]["title"] + "," + data[i]["impactLevel"] + "," + data[i]["severityLevel"] + ",no_rca,"+str(resolution_time/360000)+"\n"
    ...
    def dtApiV2PushLogs(self, query, payload):
      try:    
        logger.debug("In dtApiV2PushLogs")  
        ...
        logger.debug("Succesfully completed dtApiV2PushLogs")
